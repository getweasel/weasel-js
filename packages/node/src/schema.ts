...
export class TypeWrapper {
  ...
  static addValueType(builder: flatbuffers.Builder, valueType: Type): void {
...
export class Int {
  ...
  static addValue(builder: flatbuffers.Builder, value: flatbuffers.Long): void {
...
export class Result {
  ...
  static addTyp(builder: flatbuffers.Builder, typ: ResultType): void {
...
export class MessageBuffer {
  ...
  static startBufVector(builder: flatbuffers.Builder, numElems: number): void {
